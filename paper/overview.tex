...
%\point{Proof techniques}

%\begin{itemize}
%\itemsep10pt
  %\item Minimal norm least squares
  %\item Main lemma
  %\item Proof idea of main lemma
  %\item Error-correcting code perspective
  %\item Sample plot with alignment
  %\item Gradient descent estimators
  %\item Overview of random features and neural networks---row space of $\psi(XW)\in\reals^{n\times p}$.
%\end{itemize}
