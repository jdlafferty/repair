...
g = ggplot(dat, aes(epsilon, prob, color=p, linetype=p)) + geom_point(shape=1) + geom_line(size=0.8) + xlab('epsilon') + ylab('probability of repair') + theme(legend.key.width=unit(1,"cm"))
print(g)
